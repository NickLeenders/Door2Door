...
#DEFINE PARAMETERS
def wing_load(static= False,show=False):
    cruiseT = power.ThrustCalculator(69.4, 1000, 4000)
    cruiseL = Propellers(cruiseT.thrust, cruiseT.velocity, cruiseT.rho, cruiseT.cl)
...
def wing_deflec(data,E,I_xx,I_zz):
    int_z_1=[]
    int_x_1=[]
...
a = wing_load(static=False,show=True)

b = wing_deflec(a,228e9,2.184e-4,6.739e-6)